...
# 📖 [Create_clinic Database] <a name="about-project"></a>

**[Create_clinic Databas]** is database for storing information about patients, treatments, medical_histories, invoices and invoice_items of a  clinic.
...
git clone 'https://github.com/yodit93/Create-clinic-DB.git'
...
Feel free to check the [issues page](https://github.com/yodit93/Create-clinic-DB/issues)
